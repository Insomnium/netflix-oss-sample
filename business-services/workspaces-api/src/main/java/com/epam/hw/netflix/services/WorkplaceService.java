...
import static com.epam.hw.netflix.domain.OSFamily.WINDWOS;
...
public class WorkplaceService {
    ...
    private final List<Workspace> workspaces = newArrayList(
            new Workspace("0000001", 1, 1, randomUUID().toString(), WINDWOS),
            new Workspace("0000002", 1, 2, randomUUID().toString(), WINDWOS),
            new Workspace("0000003", 1, 3, randomUUID().toString(), WINDWOS),
            ...
            new Workspace("0000007", 1, 7, randomUUID().toString(), WINDWOS),
            new Workspace("0000008", 2, 1, randomUUID().toString(), WINDWOS),
            new Workspace("0000009", 2, 2, randomUUID().toString(), WINDWOS),
            new Workspace("0000010", 2, 3, randomUUID().toString(), OSX),
            new Workspace("0000011", 2, 4, randomUUID().toString(), OSX),
            new Workspace("0000012", 2, 5, randomUUID().toString(), WINDWOS),
            new Workspace("0000013", 2, 6, randomUUID().toString(), WINDWOS),
